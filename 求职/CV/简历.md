...
高性能计算与数据科学硕士在读，具备扎实的并行计算与分布式系统背景。熟练掌握 C/C++、Python、MPI 与 OpenMP，具有在 ARCHER2 超级计算机上进行大规模实验的实践经验。研究兴趣包括可扩展系统、性能优化，以及高性能计算与机器学习的交叉领域。

---

**Technical Skills****：**

**C/C++****、Python、SQL ; MPI、OpenMP、PETSc、Slurm、ARCHER2; Linux、Git、VS Code, linaro map**
